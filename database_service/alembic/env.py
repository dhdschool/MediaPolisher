...
def do_run_migrations(connection: Connection) -> None:
    """Configures and runs migrations using a synchronous connection."""
    context.configure(
...
async def run_async_migrations() -> None:
    ...
    async with connectable.connect() as connection:
        # run_sync executes the synchronous do_run_migrations function
...
def run_migrations_online() -> None:
    """Run migrations asynchronously in online mode from a synchronous context."""
